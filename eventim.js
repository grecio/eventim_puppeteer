...
const file = fs.readFileSync('eventim.config');
                ...
                (async () => {
                    for (const row of rows) {
                        ...
                        const params = {
                            ...
                            cartao_numero: row[8],
                            cartao_nome: row[9],
                            cartao_expira_mes: row[10],
                            cartao_expira_ano: row[11],
                            cartao_cvc: row[12]
                        };
                        ...
                        try {
                            ...
                            try {
                                ...
                                await clickAndWait(page, '#XPage_ToLogin_Link', 0)
                                await page.type('#username', params.usuario)
